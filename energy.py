...
if df is not None:
    ...
    num_placas = st.sidebar.number_input("Número de Placas:", min_value=1, value=10, step=1)
    dimensao_placa = st.sidebar.number_input("Dimensão da Placa (m²):", min_value=0.1, value=1.7, step=0.1)
    eficiencia = st.sidebar.number_input("Eficiência do Módulo (%):", min_value=1.0, max_value=100.0, value=20.0, step=0.1)
